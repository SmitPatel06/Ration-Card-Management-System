...
<head>
  ...
  <title>Online Ration Card System</title>
...
<body class="bg-gradient-primary">
  <!-- <h1>Online Ration Card Management System</h1>

  <header class="header">
		<h1 class="logo"><a href="index.php">Home</a></h1>
      <ul class="main-nav">
          <li><a href="admin_login.php">Admin Login</a></li>
          <li><a href="shop_login.php">Shop-user Login</a></li>
  	...
  	<div class="section-center">
  		<h1 class="mb-0">Online Ration Card Management System</h1>
  	</div>
